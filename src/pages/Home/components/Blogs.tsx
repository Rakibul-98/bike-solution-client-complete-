...
const blogPosts = [
  {
    ...
    description:
      "When it comes to motorcycle safety, a helmet is the most important piece of gear you can invest in. A helmet that fits properly not only protects your head in case of an accident but also ensures a more enjoyable riding experience.",
    image:
      "https://cdn-fastly.motorcycle.com/media/2025/02/18/13391/how-to-measure-for-a-motorcycle-helmet.jpg?size=720x845&nocrop=1",
  ...
  },
  {
    ...
    description:
      "There are two basic passive means of quieting the pressure pulses of waste gas being released during the exhaust phase of piston internal combustion engine operation. One is self-cancellation of sound, and the second is dissipative—the equivalent of screaming into a pillow. ",
    image:
      "https://www.cycleworld.com/resizer/8OKNr4eHY7hqNnbnNteh7jl0VLY=/1000x750/filters:focal(45x45:55x55)/cloudfront-us-east-1.images.arcpublishing.com/octane/HJYK5DYDH5DRDAY2UD4OXLQ3PM.jpg",
  ...
  },
  {
    ...
    description:
      "One of motorcycling's great debates is mileage, or rather how many miles a motorcycle can last. The short answer to that question is a decidedly anticlimactic: it depends.",
    image:
      "https://cdn-fastly.motorcycle.com/media/2025/01/14/15471/how-many-miles-can-a-motorcycle-last.jpg?size=720x845&nocrop=1",
  ...
  },
  {
    ...
    image:
      "https://www.cycleworld.com/resizer/v9PG5fLnGOu3mH4ME0HiOijhoOc=/1440x0/smart/cloudfront-us-east-1.images.arcpublishing.com/octane/RUY23BS4PVFQVP2UPF77ZIVZXA.jpg",
