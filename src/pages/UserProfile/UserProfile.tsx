...
import img from '../../assets/images/profile-cover.jpg';
  ...
  useEffect(() => {
    if (user?.data) {
      reset({
        ...
        profile_image:
          user.data.profile_image || "https://via.placeholder.com/150",
      });
    }
  }, [user, reset]);
  ...
  return (
    <div className="">
      ...
      <div className=" flex items-center justify-center mb-10">
        <div className="sm:w-96 shadow-lg rounded-xl p-6 text-center border bg-base-100">
          <div className="relative mx-auto w-24 h-24">
            ...
            <button
              ...
              onClick={() =>
                setIsEditing({
                  ...isEditing,
                  profile_image: !isEditing.profile_image,
                })
              }
            >
              <FiEdit3 />
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="mt-4 space-y-4">
            ...
            <div className="text-left space-y-2 text-gray-700">
              ...
              <p>
                ...
                {new Date(user.data.createdAt).toDateString()}
              </p>
            </div>
            ...
            {(isEditing.user_name || isEditing.profile_image) && (
              <button
                type="submit"
                className="bg-secondary text-base-100 w-full py-2 rounded-lg flex items-center justify-center gap-2 hover:bg-secondary/80"
              >
                <FiSave />
                Save Changes
              </button>
